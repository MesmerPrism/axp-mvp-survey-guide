...
- how the access handoff works between sheet editors, live survey checkers, and
  download-only users
...
- `docs/value-lifecycle.html` live survey usage and live-check-only tasks
